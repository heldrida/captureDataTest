var DataReporter = require('../../JS/Classes/DataReporter');

describe('DataReporter', function () {

		var dataReporterInstance;
		...
		describe('makeRequest', function () {
			...
			it('logs that the data has been sent to the server', function () {
				...
				expect(window.console.log).toHaveBeenCalledWith('dataCaptured: mapping id: 1 - data: data');
			});
		});
